...
// Bluetooth
#define BT_MIN_CONN_INTER_MASTER 6  // When run as para master
#define BT_MAX_CONN_INTER_MASTER 6

#define BT_MIN_CONN_INTER_PERIF 6  // When run as para slave
#define BT_MAX_CONN_INTER_PERIF 6
...
#define TRP_THREAD_PRIO PRIORITY_HIGH + 1
#define MAIN_THREAD_PRIO PRIORITY_HIGH + 2
